...
CUDNN_TAR_FILE="cudnn-linux-x86_64-8.9.2.26_cuda12-archive.tar.xz"

# Download cuDNN (you must have an NVIDIA Developer account to download this file)
wget https://developer.nvidia.com/compute/cudnn/secure/8.9.2/local_installers/12.0/${CUDNN_TAR_FILE} -O ${CUDNN_TAR_FILE}

# Extract and copy cuDNN files
tar -xf ${CUDNN_TAR_FILE}
CUDNN_DIR="cudnn-linux-x86_64-8.9.2.26_cuda12-archive"
